...
public class EditPasswordorg extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_passwordorg);
                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        if (id == R.id.settingsId) {
                            ...
                            finish();
                            Intent signOUT=new Intent(EditPasswordorg.this,loginActivity.class);
